#Definimos los colores que va a utilizar el programa:
RED='\033[91m'
GREEN='\033[92m'
YELLOW='\033[93m'
CYAN='\033[96m'
...
#creamos el archivo donde se guardaran las actualizaciones
LOG_FILE="actualizacion_$(date +%Y%m%d_%H%M%S).log"

#Aplicamos los colores a las funciones 

generar_informes(){
    echo -e "${YELLOW}Generando informes...${NC}"
